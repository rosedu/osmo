...
GtkStockItem osmo_stock_items[] = {
    ...
    { (gchar*) OSMO_STOCK_TASKS_TYPE_NORMAL,       (gchar*) N_("Normal task"),                  0, 0, TRANSLATION_DOMAIN },
    { (gchar*) OSMO_STOCK_TASKS_TYPE_RECURRENT,    (gchar*) N_("Recurrent task"),               0, 0, TRANSLATION_DOMAIN },
...
const guint8* osmo_stock_item_data[] = {
    ...
    (const guint8*) osmo_stock_tasks_type_normal,
    (const guint8*) osmo_stock_tasks_type_recurrent,
