...
gint i;
    ...
    if (config.default_stock_icons) {
        cn_font_button = gui_stock_button (GTK_STOCK_SELECT_FONT, FALSE);
    } else {
        cn_font_button = gui_stock_button (OSMO_STOCK_BUTTON_SELECT_FONT, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        ci_font_button = gui_stock_button (GTK_STOCK_SELECT_FONT, FALSE);
    } else {
        ci_font_button = gui_stock_button (OSMO_STOCK_BUTTON_SELECT_FONT, FALSE);
    }
    GTK_WIDGET_UNSET_FLAGS(cn_font_button, GTK_CAN_FOCUS);
