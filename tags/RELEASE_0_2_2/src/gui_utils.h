...
void        gui_run_command                     (gchar *command);
gboolean    gui_is_valid_command                (gchar *command);
...
void        gui_url_insert_link                 (GSList *links_list, gint *link_index, GtkWidget *textview, GtkTextIter *iter, gchar *color, gchar *font, gchar *text, gboolean center, GUI *appGUI);
