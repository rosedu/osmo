...
gchar *contact_fields_tags_name[] = {
    ...
    N_("Address"), "home_address", N_("Postcode"), "home_postcode", N_("City"), "home_city", N_("State"), 
    "home_state", N_("Country"), "home_country",
    N_("Organization"), "organization", N_("Department"), "department", N_("Address"), "work_address", 
    N_("Postcode"), "work_postcode", N_("City"), "work_city", N_("State"), "work_state", 
    N_("Country"), "work_country", N_("Fax"), "work_fax",
