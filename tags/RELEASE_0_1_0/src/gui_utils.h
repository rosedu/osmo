...
GtkWidget*  gui_stock_label_radio_button        (gchar *label, const gchar *stock);
...
void        gui_url_initialize                  (void);
void        gui_url_setup                       (GSList *links_list, gint *link_index, GtkWidget *textview);
void        gui_url_insert_link                 (GSList *links_list, gint *link_index, GtkWidget *textview, GtkTextIter *iter, gchar *color, gint font_size, gchar *text);
