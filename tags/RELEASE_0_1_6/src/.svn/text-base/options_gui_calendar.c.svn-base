...
GtkWidget           *vbox3, *vbox4, *vbox5, *vbox6, *vbox13;
GtkWidget           *hbox;
GtkWidget           *label;
GtkWidget           *hbox1;
GtkWidget           *frame;
...
GtkWidget           *calendar_ical_files_table;
    ...
    gtk_box_pack_start (GTK_BOX (vbox7), calendar_ical_files_table, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start (GTK_BOX (appGUI->opt->calendar_vbox), hbox, FALSE, TRUE, 0);
