...
gboolean    check_tasks                             (guint tc_day, guint tc_month, guint tc_year, GUI *appGUI);
gboolean    check_contacts                          (guint tc_day, guint tc_month, guint tc_year, GUI *appGUI);
...
DATE *      get_selected_date                       (GUI *appGUI);
