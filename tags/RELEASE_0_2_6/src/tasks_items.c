...
gchar tmpbuf[BUFFER_SIZE];
    ...
    aw_days_spinbutton_adj = gtk_adjustment_new (0, 0, 999999, 1, 10, 0);
    ...
    rt_end_hour_spinbutton_adj = gtk_adjustment_new (0, 0, 23, 1, 10, 0);
    ...
    rt_end_minute_spinbutton_adj = gtk_adjustment_new (0, 0, 59, 1, 10, 0);
    ...
    rt_dp_day_spinbutton_adj = gtk_adjustment_new (0, 0, 999999, 1, 10, 0);
    ...
    rt_dp_month_spinbutton_adj = gtk_adjustment_new (0, 0, 999999, 1, 10, 0);
    ...
    repeat_counter_spinbutton_adj = gtk_adjustment_new (0, 0, 999999, 1, 10, 0);
				...
				while (node != NULL) {
					...
					if (!xmlStrcmp (node->name, (xmlChar *) "entry")) {
						...
						while (cnode != NULL) {
							...
							utl_xml_get_int ("active_warning", &(item->active_warning), cnode);
