...
void
utl_gui_text_buffer_set_text_with_tags (GtkTextBuffer *buffer, const gchar *text) {
...
void 
utl_gui_url_insert_link (GSList *links_list, gint *link_index, GtkWidget *textview, 
