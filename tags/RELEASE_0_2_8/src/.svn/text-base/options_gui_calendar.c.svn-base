...
void
birthday_mark_color_changed_cb (GtkColorButton *widget, gpointer user_data) {
...
GdkColor color;
    ...
    gtk_color_button_get_color (GTK_COLOR_BUTTON(appGUI->opt->birthday_mark_color_picker), &color);
    sprintf (tmpbuf, "#%02X%02X%02X", color.red * 256 / 65536, color.green * 256 / 65536, color.blue * 256 / 65536);
    strncpy (config.birthday_mark_color, tmpbuf, MAXCOLORNAME-1);
...
gchar tmpbuf[BUFFER_SIZE];
    ...
    gtk_tree_model_get (GTK_TREE_MODEL(model), iter, 
					    ICAL_COLUMN_NAME, &ical_name, 
					    ICAL_COLUMN_FILENAME, &ical_filename, -1);
...
#ifdef HAVE_LIBICAL
void
ical_mark_toggled (GtkCellRendererToggle *cell, gchar *path_str, gpointer data) {
...
GtkWidget           *calendar_ical_files_table;
    ...
    sprintf (tmpbuf, "%s", config.day_note_marker);
	...
	if (config.enable_tooltips) {
		gtk_widget_set_tooltip_text (appGUI->opt->header_color_picker, _("Header color"));
	}
	...
	if (config.enable_tooltips) {
		gtk_widget_set_tooltip_text (appGUI->opt->weekend_color_picker, _("Weekend days color"));
	}
	...
	if (config.enable_tooltips) {
		gtk_widget_set_tooltip_text (appGUI->opt->selection_color_picker, _("Cursor color"));
	}
	...
	if (config.enable_tooltips) {
		gtk_widget_set_tooltip_text (appGUI->opt->mark_color_picker, _("Event marker color"));
	}
	...
	if (config.enable_tooltips) {
		gtk_widget_set_tooltip_text (appGUI->opt->mark_current_day_color_picker, _("Current day marker color"));
	}
	...
	appGUI->opt->birthday_mark_color_picker = gtk_color_button_new ();
    g_signal_connect (G_OBJECT (appGUI->opt->birthday_mark_color_picker), "color-set",
                      G_CALLBACK(birthday_mark_color_changed_cb), appGUI);
    gtk_widget_show (appGUI->opt->birthday_mark_color_picker);
	if (config.enable_tooltips) {
		gtk_widget_set_tooltip_text (appGUI->opt->birthday_mark_color_picker, _("Birthday marker color"));
	}
    gdk_color_parse(config.birthday_mark_color, &color);
    gtk_color_button_set_color (GTK_COLOR_BUTTON (appGUI->opt->birthday_mark_color_picker), &color);
    gtk_box_pack_start (GTK_BOX (colors_hbox), appGUI->opt->birthday_mark_color_picker, FALSE, FALSE, 0);
    ...
    if (config.default_stock_icons) {
        calendar_font_button = utl_gui_stock_button (GTK_STOCK_SELECT_FONT, FALSE);
    } else {
        calendar_font_button = utl_gui_stock_button (OSMO_STOCK_BUTTON_SELECT_FONT, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        notes_font_button = utl_gui_stock_button (GTK_STOCK_SELECT_FONT, FALSE);
    } else {
        notes_font_button = utl_gui_stock_button (OSMO_STOCK_BUTTON_SELECT_FONT, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        appGUI->opt->calendar_category_add_button = utl_gui_stock_button (GTK_STOCK_ADD, FALSE);
    } else {
        appGUI->opt->calendar_category_add_button = utl_gui_stock_button (OSMO_STOCK_BUTTON_ADD, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        appGUI->opt->calendar_category_edit_button = utl_gui_stock_button(GTK_STOCK_EDIT, FALSE);
    } else {
        appGUI->opt->calendar_category_edit_button = utl_gui_stock_button(OSMO_STOCK_BUTTON_EDIT, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        appGUI->opt->calendar_category_remove_button = utl_gui_stock_button(GTK_STOCK_REMOVE, FALSE);
    } else {
        appGUI->opt->calendar_category_remove_button = utl_gui_stock_button(OSMO_STOCK_BUTTON_REMOVE, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        appGUI->opt->calendar_ical_files_browse_button = utl_gui_stock_button (GTK_STOCK_DIRECTORY, FALSE);
    } else {
        appGUI->opt->calendar_ical_files_browse_button = utl_gui_stock_button (OSMO_STOCK_BUTTON_OPEN, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        appGUI->opt->calendar_ical_files_add_button = utl_gui_stock_button(GTK_STOCK_ADD, FALSE);
    } else {
        appGUI->opt->calendar_ical_files_add_button = utl_gui_stock_button(OSMO_STOCK_BUTTON_ADD, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        appGUI->opt->calendar_ical_files_edit_button = utl_gui_stock_button(GTK_STOCK_EDIT, FALSE);
    } else {
        appGUI->opt->calendar_ical_files_edit_button = utl_gui_stock_button(OSMO_STOCK_BUTTON_EDIT, FALSE);
    }
    ...
    if (config.default_stock_icons) {
        appGUI->opt->calendar_ical_files_remove_button = utl_gui_stock_button(GTK_STOCK_REMOVE, FALSE);
    } else {
        appGUI->opt->calendar_ical_files_remove_button = utl_gui_stock_button(OSMO_STOCK_BUTTON_REMOVE, FALSE);
    }
    ...
    appGUI->opt->calendar_ical_files_store = gtk_list_store_new(ICAL_NUMBER_OF_COLUMNS, GDK_TYPE_PIXBUF, 
    ...
    gtk_widget_set_size_request (appGUI->opt->calendar_ical_files_treeview, -1, 220);
    ...
    column = gtk_tree_view_column_new_with_attributes(_("Full date"), renderer, "active", ICAL_COLUMN_FULL_DATE, NULL);
    gtk_tree_view_append_column(GTK_TREE_VIEW(appGUI->opt->calendar_ical_files_treeview), column);
    ...
    column = gtk_tree_view_column_new_with_attributes(_("Mark"), renderer, "active", ICAL_COLUMN_MARK, NULL);
    gtk_tree_view_append_column(GTK_TREE_VIEW(appGUI->opt->calendar_ical_files_treeview), column);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->week_start_monday_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->show_day_names_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->no_month_change_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->show_week_numbers_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->simple_view_in_fy_calendar_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->enable_auxilary_calendars_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->strikethrough_past_notes_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->ascending_sorting_in_day_notes_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
...
#ifdef HAVE_GTKSPELL
    appGUI->opt->spell_checker_in_day_notes_checkbutton = gtk_check_button_new_with_mnemonic (_("Enable spell checker in day notes"));
    GTK_WIDGET_UNSET_FLAGS(appGUI->opt->spell_checker_in_day_notes_checkbutton, GTK_CAN_FOCUS);
    g_signal_connect (G_OBJECT (appGUI->opt->spell_checker_in_day_notes_checkbutton), "toggled",
                      G_CALLBACK (calendar_options_cb), appGUI);
    gtk_widget_show (appGUI->opt->spell_checker_in_day_notes_checkbutton);
    gtk_table_attach (GTK_TABLE (table), appGUI->opt->spell_checker_in_day_notes_checkbutton, 0, 1, i, i+1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
