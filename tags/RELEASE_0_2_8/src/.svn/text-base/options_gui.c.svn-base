...
GtkWidget           *vbox1, *vbox2, *hbox = NULL;
...
GSList              *radiobutton_group = NULL;
    ...
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON(appGUI->opt->enable_rules_hint_checkbutton), 
                                  config.rules_hint);
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON(appGUI->opt->enable_tooltips_checkbutton), 
                                  config.enable_tooltips);
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON(appGUI->opt->override_locale_checkbutton), 
    ...
    gtk_entry_set_text (GTK_ENTRY(appGUI->opt->entry_sound_player), config.sound_player);
	...
	override_locale_changed_cb (NULL, appGUI);
