...
gchar *contact_replace_tags[] = {
    ...
    gtk_window_set_default_size (GTK_WINDOW(appGUI->cnt->contacts_add_window), CONTACTS_ADD_EDIT_WINDOW_SIZE_X, CONTACTS_ADD_EDIT_WINDOW_SIZE_Y);
    ...
    gtk_window_move (GTK_WINDOW (appGUI->cnt->contacts_add_window), config.contacts_add_edit_window_x, config.contacts_add_edit_window_y);
