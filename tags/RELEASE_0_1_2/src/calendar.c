...
gint ydays;
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->cal->day_number_label, 1, 2, 0, 1,
                      (GtkAttachOptions) (GTK_FILL),
                      (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->cal->day_number_year_label, 2, 3, 0, 1,
                      (GtkAttachOptions) (GTK_FILL),
                      (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->cal->week_number_label, 1, 3, 2, 3,
                      (GtkAttachOptions) (GTK_FILL),
                      (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->cal->marked_days_label, 1, 3, 1, 2,
                      (GtkAttachOptions) (GTK_FILL),
                      (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->cal->weekend_days_label, 1, 3, 3, 4,
                      (GtkAttachOptions) (GTK_FILL),
                      (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->cal->moon_icon, 1, 2, 4, 5,
                      (GtkAttachOptions) (GTK_FILL),
                      (GtkAttachOptions) (0), 0, 0);
    ...
    gtk_table_attach (GTK_TABLE (table), appGUI->cal->moon_phase_label, 2, 3, 4, 5,
                      (GtkAttachOptions) (GTK_FILL),
                      (GtkAttachOptions) (0), 0, 0);
    ...
    sprintf(tmpbuf, "(%d %s)", get_days_per_year(dyear)-ydays,
        ngettext ("day till end of year", "days till end of year", get_days_per_year(dyear)-ydays));
