...
gint year2, month2, day2, hour2, minute2, second2;
guint year3, month3, day3, week3, hour3, minute3, second3;
/*long long unsigned int minute4, second4;*/
guint64 minute4, second4;
gint n;
gchar tmpbuf[BUFFER_SIZE];

    year3 = month3 = day3 = week3 = hour3 = minute3 = second3 = 0;
    ...
    n = (gint)get_number_of_days_in_month (month2, year2);
    if (day2 > n) {
        day2 = n;
    }
    ...
    n = (gint)(date_to_julian (day2, month2, year2) - date_to_julian (day, month, year));

    if (n < 0 || (n == 0 && hour*3600+minute*60+second > hour2*3600+minute2*60+second2)) {
        ...
        if (day2 < day) {
            ...
            day2 += (gint)get_number_of_days_in_month (month2, year2);
        }
        day3 = day2 - day;
        ...
        sprintf (tmpbuf, "<big>%d %s, %d %s, %d %s</big>",
            year3, ngettext ("year", "years", year3),
            month3, ngettext ("month", "months", month3),
            day3, ngettext ("day", "days", day3));
        gtk_label_set_markup (GTK_LABEL (appGUI->cal->label_result_1), tmpbuf);

        sprintf (tmpbuf, "<big>%d %s, %d %s, %d %s</big>",
            hour3, ngettext ("hour", "hours", hour3),
            minute3, ngettext ("minute", "minutes", minute3),
            second3, ngettext ("second", "seconds", second3));
        ...
        sprintf (tmpbuf, "<small>(%s: %d %s, %d %s, %d %s, %d %s)</small>",
            _("or"),
            n, ngettext ("day", "days", n),
            hour3, ngettext ("hour", "hours", hour3),
            minute3, ngettext ("minute", "minutes", minute3),
            second3, ngettext ("second", "seconds", second3));
        gtk_label_set_markup (GTK_LABEL (appGUI->cal->label_result_2), tmpbuf);

        second4 = (guint64)second3 + (guint64)minute3 * 60 + (guint64)hour3 * 3600 + (guint64)n * 24 * 3600;
        minute4 = second4 / 60;
        hour3 = minute4 / 60;
        week3 = hour3 / (24 * 7);
        sprintf (tmpbuf, "<small>%llu %s\n%llu %s (%s)\n%d %s (%s)\n%d %s (%s)</small>",
            second4, ngettext ("second", "seconds", second4),
            minute4, ngettext ("minute", "minutes", minute4), _("rounded down"),
            hour3, ngettext ("hour", "hours", hour3), _("rounded down"),
            week3, ngettext ("week", "weeks", week3), _("rounded down"));
