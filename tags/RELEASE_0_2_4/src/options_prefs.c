		...
		while (node != NULL) {
			...
			if ((!xmlStrcmp (node->name, (const xmlChar *) "general"))) {
				...
				while (general_node != NULL) {
					utl_xml_get_int ("window_x", &config.window_x, general_node, doc);
					utl_xml_get_int ("window_y", &config.window_y, general_node, doc);
					utl_xml_get_int ("window_size_x", &config.window_size_x, general_node, doc);
					utl_xml_get_int ("window_size_y", &config.window_size_y, general_node, doc);
					utl_xml_get_int ("enable_tooltips", &config.enable_tooltips, general_node, doc);
					utl_xml_get_int ("latest_tab", &config.latest_tab, general_node, doc);
					utl_xml_get_int ("tabs_position", &config.tabs_position, general_node, doc);
					utl_xml_get_int ("remember_latest_tab", &config.remember_latest_tab, general_node, doc);
					utl_xml_get_int ("save_data_after_modification", &config.save_data_after_modification, general_node, doc);
					utl_xml_get_int ("default_stock_icons", &config.default_stock_icons, general_node, doc);
					utl_xml_get_int ("disable_underline_links", &config.disable_underline_links, general_node, doc);
					utl_xml_get_int ("date_format", &config.date_format, general_node, doc);
					utl_xml_get_int ("time_format", &config.time_format, general_node, doc);
					utl_xml_get_int ("enable_systray", &config.enable_systray, general_node, doc);
					utl_xml_get_int ("start_minimised_in_systray", &config.start_minimised_in_systray, general_node, doc);
					utl_xml_get_int ("run_counter", &config.run_counter, general_node, doc);
					utl_xml_get_int ("lastrun_date", &config.lastrun_date, general_node, doc);
					utl_xml_get_int ("lastrun_time", &config.lastrun_time, general_node, doc);
					utl_xml_get_int ("hide_calendar", &config.hide_calendar, general_node, doc);
					utl_xml_get_int ("hide_tasks", &config.hide_tasks, general_node, doc);
					utl_xml_get_int ("hide_contacts", &config.hide_contacts, general_node, doc);
					utl_xml_get_int ("hide_notes", &config.hide_notes, general_node, doc);
					utl_xml_get_strn ("web_browser", config.web_browser, MAXHELPERCMD, general_node, doc);
					utl_xml_get_strn ("email_client", config.email_client, MAXHELPERCMD, general_node, doc);
			...
			if ((!xmlStrcmp (node->name, (const xmlChar *) "calendar"))) {
				...
				while (calendar_node != NULL) {
					utl_xml_get_int ("fy_window_size_x", &config.fy_window_size_x, calendar_node, doc);
					utl_xml_get_int ("fy_window_size_y", &config.fy_window_size_y, calendar_node, doc);
					utl_xml_get_int ("fy_simple_view", &config.fy_simple_view, calendar_node, doc);
					utl_xml_get_int ("fy_alternative_view", &config.fy_alternative_view, calendar_node, doc);
					utl_xml_get_int ("display_options", &config.display_options, calendar_node, doc);
					utl_xml_get_int ("day_notes_visible", &config.day_notes_visible, calendar_node, doc);
					utl_xml_get_int ("timeline_start", &config.timeline_start, calendar_node, doc);
					utl_xml_get_int ("timeline_end", &config.timeline_end, calendar_node, doc);
					utl_xml_get_int ("timeline_step", &config.timeline_step, calendar_node, doc);
					utl_xml_get_int ("di_show_current_time", &config.di_show_current_time, calendar_node, doc);
					utl_xml_get_int ("di_show_day_number", &config.di_show_day_number, calendar_node, doc);
					utl_xml_get_int ("di_show_current_day_distance", &config.di_show_current_day_distance, calendar_node, doc);
					utl_xml_get_int ("di_show_marked_days", &config.di_show_marked_days, calendar_node, doc);
					utl_xml_get_int ("di_show_week_number", &config.di_show_week_number, calendar_node, doc);
					utl_xml_get_int ("di_show_weekend_days", &config.di_show_weekend_days, calendar_node, doc);
					utl_xml_get_int ("di_show_day_category", &config.di_show_day_category, calendar_node, doc);
					utl_xml_get_int ("di_show_moon_phase", &config.di_show_moon_phase, calendar_node, doc);
					utl_xml_get_int ("di_show_notes", &config.di_show_notes, calendar_node, doc);
					utl_xml_get_int ("di_show_zodiac_sign", &config.di_show_zodiac_sign, calendar_node, doc);
					utl_xml_get_int ("cursor_type", &config.cursor_type, calendar_node, doc);
					utl_xml_get_int ("frame_cursor_thickness", &config.frame_cursor_thickness, calendar_node, doc);
					utl_xml_get_int ("enable_auxilary_calendars", &config.enable_auxilary_calendars, calendar_node, doc);
					utl_xml_get_int ("enable_day_mark", &config.enable_day_mark, calendar_node, doc);
					utl_xml_get_int ("strikethrough_past_notes", &config.strikethrough_past_notes, calendar_node, doc);
					utl_xml_get_int ("ascending_sorting_in_day_notes_browser", &config.ascending_sorting_in_day_notes_browser, calendar_node, doc);
					utl_xml_get_int ("auxilary_calendars_state", &config.auxilary_calendars_state, calendar_node, doc);
					utl_xml_get_char ("day_note_marker", &config.day_note_marker, calendar_node, doc);
					utl_xml_get_int ("event_marker_type", &config.event_marker_type, calendar_node, doc);
					utl_xml_get_int ("today_marker_type", &config.today_marker_type, calendar_node, doc);
					utl_xml_get_int ("day_notes_browser_filter", &config.day_notes_browser_filter, calendar_node, doc);
					utl_xml_get_int ("ical_export_pane_pos", &config.ical_export_pane_pos, calendar_node, doc);
					utl_xml_get_strn ("header_color", config.header_color, MAXCOLORNAME, calendar_node, doc);
					utl_xml_get_strn ("weekend_color", config.weekend_color, MAXCOLORNAME, calendar_node, doc);
					utl_xml_get_strn ("selection_color", config.selection_color, MAXCOLORNAME, calendar_node, doc);
					utl_xml_get_strn ("mark_color", config.mark_color, MAXCOLORNAME, calendar_node, doc);
					utl_xml_get_strn ("mark_current_day_color", config.mark_current_day_color, MAXCOLORNAME, calendar_node, doc);
					utl_xml_get_int ("mark_current_day_alpha", &config.mark_current_day_alpha, calendar_node, doc);
					utl_xml_get_int ("selector_alpha", &config.selector_alpha, calendar_node, doc);
					utl_xml_get_strn ("day_name_font", config.day_name_font, MAXFONTNAME, calendar_node, doc);
					utl_xml_get_strn ("calendar_font", config.calendar_font, MAXFONTNAME, calendar_node, doc);
					utl_xml_get_strn ("notes_font", config.notes_font, MAXFONTNAME, calendar_node, doc);
			...
			if ((!xmlStrcmp (node->name, (const xmlChar *) "tasks"))) {
				...
				while (tasks_node != NULL) {
					utl_xml_get_int ("rules_hint", &config.tasks_rules_hint, tasks_node, doc);
					utl_xml_get_int ("high_priority_in_bold", &config.tasks_high_in_bold, tasks_node, doc);
					utl_xml_get_int ("hide_completed", &config.hide_completed, tasks_node, doc);
					utl_xml_get_int ("delete_completed", &config.delete_completed, tasks_node, doc);
					utl_xml_get_int ("add_edit", &config.add_edit, tasks_node, doc);
					utl_xml_get_int ("remember_category", &config.remember_category_in_tasks, tasks_node, doc);
					utl_xml_get_int ("current_category", &config.current_category_in_tasks, tasks_node, doc);
					utl_xml_get_int ("pane_pos", &config.tasks_pane_pos, tasks_node, doc);
					utl_xml_get_int ("tasks_sorting_order", &config.tasks_sorting_order, tasks_node, doc);
					utl_xml_get_int ("tasks_sorting_mode", &config.tasks_sorting_mode, tasks_node, doc);
					utl_xml_get_int ("visible_due_date_column", &config.visible_due_date_column, tasks_node, doc);
					utl_xml_get_int ("visible_type_column", &config.visible_type_column, tasks_node, doc);
					utl_xml_get_int ("visible_priority_column", &config.visible_priority_column, tasks_node, doc);
					utl_xml_get_int ("visible_category_column", &config.visible_category_column, tasks_node, doc);
					utl_xml_get_int ("tasks_addedit_win_x", &config.tasks_addedit_win_x, tasks_node, doc);
					utl_xml_get_int ("tasks_addedit_win_y", &config.tasks_addedit_win_y, tasks_node, doc);
					utl_xml_get_int ("tasks_addedit_win_w", &config.tasks_addedit_win_w, tasks_node, doc);
					utl_xml_get_int ("tasks_addedit_win_h", &config.tasks_addedit_win_h, tasks_node, doc);
					utl_xml_get_int ("postpone_time", &config.postpone_time, tasks_node, doc);
					utl_xml_get_strn ("due_today_color", config.due_today_color, MAXCOLORNAME, tasks_node, doc);
					utl_xml_get_strn ("due_7days_color", config.due_7days_color, MAXCOLORNAME, tasks_node, doc);
					utl_xml_get_strn ("past_due_color", config.past_due_color, MAXCOLORNAME, tasks_node, doc);
					utl_xml_get_strn ("task_info_font", config.task_info_font, MAXFONTNAME, tasks_node, doc);
					utl_xml_get_strn ("global_notification_command", config.global_notification_command, MAXHELPERCMD, tasks_node, doc);
			...
			if ((!xmlStrcmp (node->name, (const xmlChar *) "contacts"))) {
				...
				while (contacts_node != NULL) {
					utl_xml_get_int ("find_mode", &config.find_mode, contacts_node, doc);
					utl_xml_get_int ("show_after_search", &config.show_after_search, contacts_node, doc);
					utl_xml_get_int ("hide_group_column", &config.hide_group_column, contacts_node, doc);
					utl_xml_get_int ("pane_pos", &config.contacts_pane_pos, contacts_node, doc);
					utl_xml_get_int ("rules_hint", &config.contacts_rules_hint, contacts_node, doc);
					utl_xml_get_int ("photo_width", &config.photo_width, contacts_node, doc);
					utl_xml_get_int ("visible_age_column", &config.visible_age_column, contacts_node, doc);
					utl_xml_get_int ("visible_birthday_date_column", &config.visible_birthday_date_column, contacts_node, doc);
					utl_xml_get_int ("visible_zodiac_sign_column", &config.visible_zodiac_sign_column, contacts_node, doc);
					utl_xml_get_strn ("contact_tag_color", config.contact_tag_color, MAXCOLORNAME, contacts_node, doc);
					utl_xml_get_strn ("contact_link_color", config.contact_link_color, MAXCOLORNAME, contacts_node, doc);
					utl_xml_get_strn ("contact_name_font", config.contact_name_font, MAXFONTNAME, contacts_node, doc);
					utl_xml_get_strn ("contact_item_font", config.contact_item_font, MAXFONTNAME, contacts_node, doc);
					utl_xml_get_int ("export_format", &config.export_format, contacts_node, doc);
					utl_xml_get_strn ("export_fields", config.export_fields, MAXCONTACTFIELDS, contacts_node, doc);
					utl_xml_get_int ("contacts_sorting_order", &config.contacts_sorting_order, contacts_node, doc);
					utl_xml_get_int ("contacts_sorting_mode", &config.contacts_sorting_mode, contacts_node, doc);
					utl_xml_get_int ("contacts_addedit_win_x", &config.contacts_addedit_win_x, contacts_node, doc);
					utl_xml_get_int ("contacts_addedit_win_y", &config.contacts_addedit_win_y, contacts_node, doc);
					utl_xml_get_int ("contacts_addedit_win_w", &config.contacts_addedit_win_w, contacts_node, doc);
					utl_xml_get_int ("contacts_addedit_win_h", &config.contacts_addedit_win_h, contacts_node, doc);
					utl_xml_get_int ("contacts_export_win_x", &config.contacts_export_win_x, contacts_node, doc);
					utl_xml_get_int ("contacts_export_win_y", &config.contacts_export_win_y, contacts_node, doc);
					utl_xml_get_int ("contacts_export_win_w", &config.contacts_export_win_w, contacts_node, doc);
					utl_xml_get_int ("contacts_export_win_h", &config.contacts_export_win_h, contacts_node, doc);
					utl_xml_get_int ("contacts_import_sel_win_x", &config.contacts_import_sel_win_x, contacts_node, doc);
					utl_xml_get_int ("contacts_import_sel_win_y", &config.contacts_import_sel_win_y, contacts_node, doc);
					utl_xml_get_int ("contacts_import_win_x", &config.contacts_import_win_x, contacts_node, doc);
					utl_xml_get_int ("contacts_import_win_y", &config.contacts_import_win_y, contacts_node, doc);
					utl_xml_get_int ("contacts_import_win_w", &config.contacts_import_win_w, contacts_node, doc);
					utl_xml_get_int ("contacts_import_win_h", &config.contacts_import_win_h, contacts_node, doc);
					utl_xml_get_int ("contacts_birthdays_win_w", &config.contacts_birthdays_win_w, contacts_node, doc);
					utl_xml_get_int ("contacts_birthdays_win_h", &config.contacts_birthdays_win_h, contacts_node, doc);
					utl_xml_get_int ("import_type", &config.import_type, contacts_node, doc);
					utl_xml_get_int ("import_interface_type", &config.import_interface_type, contacts_node, doc);
					utl_xml_get_int ("import_bluetooth_channel", &config.import_bluetooth_channel, contacts_node, doc);
					utl_xml_get_int ("import_usb_interface", &config.import_usb_interface, contacts_node, doc);
					utl_xml_get_int ("import_binary_xml", &config.import_binary_xml, contacts_node, doc);
					utl_xml_get_strn ("import_bluetooth_address", config.import_bluetooth_address, MAXADDRESS, contacts_node, doc);
			...
			if ((!xmlStrcmp (node->name, (const xmlChar *) "notes"))) {
				...
				while (notes_node != NULL) {
					utl_xml_get_int ("rules_hint", &config.notes_rules_hint, notes_node, doc);
					utl_xml_get_int ("enc_algorithm", &config.notes_enc_algorithm, notes_node, doc);
					utl_xml_get_int ("enc_hashing", &config.notes_enc_hashing, notes_node, doc);
					utl_xml_get_int ("comp_algorithm", &config.notes_comp_algorithm, notes_node, doc);
					utl_xml_get_int ("comp_ratio", &config.notes_comp_ratio, notes_node, doc);
					utl_xml_get_int ("sorting_order", &config.notes_sorting_order, notes_node, doc);
					utl_xml_get_int ("sorting_mode", &config.notes_sorting_mode, notes_node, doc);
					utl_xml_get_int ("remember_category", &config.remember_category_in_notes, notes_node, doc);
					utl_xml_get_int ("current_category", &config.current_category_in_notes, notes_node, doc);
					utl_xml_get_int ("use_system_date", &config.use_system_date_in_notes, notes_node, doc);
					utl_xml_get_char ("text_separator", &config.text_separator, notes_node, doc);
					utl_xml_get_strn ("editor_font", config.notes_editor_font, MAXFONTNAME, notes_node, doc);
...
xmlNodePtr node, general_node, calendar_node, tasks_node, contacts_node, notes_node;
	...
	utl_xml_put_strn ("web_browser", config.web_browser, MAXHELPERCMD, general_node);
	utl_xml_put_strn ("email_client", config.email_client, MAXHELPERCMD, general_node);
	...
	utl_xml_put_char ("day_note_marker", config.day_note_marker, calendar_node);
	...
	utl_xml_put_strn ("header_color", config.header_color, MAXCOLORNAME, calendar_node);
	utl_xml_put_strn ("weekend_color", config.weekend_color, MAXCOLORNAME, calendar_node);
	utl_xml_put_strn ("selection_color", config.selection_color, MAXCOLORNAME, calendar_node);
	utl_xml_put_strn ("mark_color", config.mark_color, MAXCOLORNAME, calendar_node);
	utl_xml_put_strn ("mark_current_day_color", config.mark_current_day_color, MAXCOLORNAME, calendar_node);
	...
	utl_xml_put_strn ("day_name_font", config.day_name_font, MAXFONTNAME, calendar_node);
	utl_xml_put_strn ("calendar_font", config.calendar_font, MAXFONTNAME, calendar_node);
	utl_xml_put_strn ("notes_font", config.notes_font, MAXFONTNAME, calendar_node);
	...
	utl_xml_put_int ("visible_due_date_column", config.visible_due_date_column, tasks_node);
	utl_xml_put_int ("visible_type_column", config.visible_type_column, tasks_node);
	utl_xml_put_int ("visible_priority_column", config.visible_priority_column, tasks_node);
	utl_xml_put_int ("visible_category_column", config.visible_category_column, tasks_node);
	...
	utl_xml_put_strn ("due_today_color", config.due_today_color, MAXCOLORNAME, tasks_node);
	utl_xml_put_strn ("due_7days_color", config.due_7days_color, MAXCOLORNAME, tasks_node);
	utl_xml_put_strn ("past_due_color", config.past_due_color, MAXCOLORNAME, tasks_node);
	utl_xml_put_strn ("task_info_font", config.task_info_font, MAXFONTNAME, tasks_node);
	utl_xml_put_strn ("global_notification_command", config.global_notification_command, MAXHELPERCMD, tasks_node);
	...
	utl_xml_put_int ("visible_age_column", config.visible_age_column, contacts_node);
	utl_xml_put_int ("visible_birthday_date_column", config.visible_birthday_date_column, contacts_node);
	utl_xml_put_int ("visible_zodiac_sign_column", config.visible_zodiac_sign_column, contacts_node);
	utl_xml_put_strn ("contact_tag_color", config.contact_tag_color, MAXCOLORNAME, contacts_node);
	utl_xml_put_strn ("contact_link_color", config.contact_link_color, MAXCOLORNAME, contacts_node);
	utl_xml_put_strn ("contact_name_font", config.contact_name_font, MAXFONTNAME, contacts_node);
	utl_xml_put_strn ("contact_item_font", config.contact_item_font, MAXFONTNAME, contacts_node);
	utl_xml_put_int ("export_format", config.export_format, contacts_node);
	utl_xml_put_strn ("export_fields", config.export_fields, MAXCONTACTFIELDS, contacts_node);
	...
	utl_xml_put_strn ("import_bluetooth_address", config.import_bluetooth_address, MAXADDRESS, contacts_node);
	...
	utl_xml_put_char ("text_separator", config.text_separator, notes_node);
	utl_xml_put_strn ("editor_font", config.notes_editor_font, MAXFONTNAME, notes_node);
