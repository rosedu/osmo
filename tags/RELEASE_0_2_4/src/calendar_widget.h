...
void       gui_calendar_set_selector_alpha  (GuiCalendar *calendar, gint alpha_value);
void       gui_calendar_set_event_marker_color (GuiCalendar *calendar, const gchar *color);
void       gui_calendar_set_today_marker_color (GuiCalendar *calendar, const gchar *color);
void       gui_calendar_set_today_marker_alpha (GuiCalendar *calendar, gint alpha_value);
...
void       gui_calendar_set_day_note_marker_type   (GuiCalendar *calendar, const gchar symbol);
void       gui_calendar_set_event_marker_type      (GuiCalendar *calendar, gint marker_type);
void       gui_calendar_set_today_marker_type      (GuiCalendar *calendar, gint marker_type);
