...
guint n_entries = G_N_ELEMENTS (entries);
	...
	g_signal_connect (G_OBJECT (gtk_ui_manager_get_widget (appGUI->cnt->contacts_uim_widget, "/toolbar/preferences")), "clicked",
	                  G_CALLBACK (show_preferences_window_cb), appGUI);

	g_signal_connect (G_OBJECT (gtk_ui_manager_get_widget (appGUI->cnt->contacts_uim_widget, "/toolbar/about")), "clicked",
