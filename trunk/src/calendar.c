...
guint n_t_entries = G_N_ELEMENTS (t_entries);
	...
	g_signal_connect (G_OBJECT (gtk_ui_manager_get_widget (uim_widget, "/toolbar/preferences")), "clicked",
	                  G_CALLBACK (show_preferences_window_cb), appGUI);

	g_signal_connect (G_OBJECT (gtk_ui_manager_get_widget (uim_widget, "/toolbar/about")), "clicked",
